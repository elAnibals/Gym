...
namespace GymManager.DataAccess.Repositories
{
    public class Repository<TId, TEntity> : IRepository<TId, TEntity> where TEntity : class, new()
    {
        ...
        {
            if (entity == null) throw new ArgumentNullException($"{nameof(AddAsync)} entity most not be null");
        ...
        {
            if (entity == null) throw new ArgumentNullException($"{nameof(UpdateAsync)} entity most not be null");
